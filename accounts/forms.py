...
class UserProfileColorForm(forms.ModelForm):
    ...
    def clean_color(self):
        ...
        m = re.match(regex, color)
        if not m:
            raise forms.ValidationError('Please type a valid color code ')
        return m.string
